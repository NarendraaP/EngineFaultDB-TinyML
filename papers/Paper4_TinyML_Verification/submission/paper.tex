...
\thanks{Manuscript received August 20, 2026. (Corresponding author: Narendra Satish, e-mail: narendresh.p@gmail.com). This research was conducted as part of the empirical software engineering and verification initiative.}%
}

% \markboth{IEEE Transactions on Software Engineering, August~2026}%
% {Satish: An Independent Verification Framework for Reproducible TinyML Evaluation}
...
\resizebox{\textwidth}{!}{%
\begin{tabular}{r l l r r l l r r p{4.5cm}}
\toprule
\textbf{\#} & \textbf{Model Identifier} & \textbf{Metric} & \textbf{Initial Val.} & \textbf{Verified Val.} & \textbf{Initial Source} & \textbf{Verified Source} & \textbf{Abs. $\Delta$} & \textbf{$\Delta$ (\%)} & \textbf{Root Cause / Corrective Action} \\
\midrule
...
\begin{enumerate}
    ...
    \item \textbf{Verify Zero-Float Graphs:} Automate tensor inspection to verify zero remaining float32 operations before claiming integer inference.
